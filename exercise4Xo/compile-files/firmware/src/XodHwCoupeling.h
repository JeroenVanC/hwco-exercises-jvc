...
#define  STATE_REG_out_4 (*(volatile unsigned int *)(XOODYAK_BASE_ADDR + 16 * 4))
#define  STATE_REG_out_5 (*(volatile unsigned int *)(XOODYAK_BASE_ADDR + 17 * 4))
#define  STATE_REG_out_6 (*(volatile unsigned int *)(XOODYAK_BASE_ADDR + 18 * 4))
#define  STATE_REG_out_7 (*(volatile unsigned int *)(XOODYAK_BASE_ADDR + 19 * 4))
#define  STATE_REG_out_8 (*(volatile unsigned int *)(XOODYAK_BASE_ADDR + 20 * 4))
#define  STATE_REG_out_9 (*(volatile unsigned int *)(XOODYAK_BASE_ADDR + 21 * 4))
#define  STATE_REG_out_10 (*(volatile unsigned int *)(XOODYAK_BASE_ADDR + 22 * 4))
#define  STATE_REG_out_11 (*(volatile unsigned int *)(XOODYAK_BASE_ADDR + 23 * 4))
